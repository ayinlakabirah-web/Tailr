-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('NEW', 'IN_PROGRESS', 'READY', 'DELIVERED');
...
-- CreateIndex
CREATE UNIQUE INDEX "Customer_fullName_phoneNumber_vendorId_key" ON "Customer"("fullName", "phoneNumber", "vendorId");
...
-- AddForeignKey
ALTER TABLE "Customer" ADD CONSTRAINT "Customer_vendorId_fkey" FOREIGN KEY ("vendorId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
